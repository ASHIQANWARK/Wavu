...
const GetInvolved = () => {
  return (
    <section className="py-16 bg-gray-100 text-center">
      <h2 className="text-3xl font-bold text-[#11698E]">Get Involved</h2>
      ...
      <div className="grid md:grid-cols-3 gap-8 mt-10 max-w-6xl mx-auto px-4">
        ...
        <div className="bg-white shadow-lg rounded-lg p-6 text-center relative">
          ...
          <div className="relative z-10 flex justify-center">
            <FaHandHoldingUsd className="text-[#11698E] text-5xl" />
          </div>
        ...
        <div className="bg-white shadow-lg rounded-lg p-6 text-center relative">
          ...
          />
          <div className="relative z-10 flex justify-center">
            <FaHandshake className="text-[#11698E] text-5xl" />
          </div>
        ...
        <div className="bg-white shadow-lg rounded-lg p-6 text-center relative">
          ...
          />
          <div className="relative z-10 flex justify-center">
            <FaUserFriends className="text-[#11698E] text-5xl" />
          </div>
