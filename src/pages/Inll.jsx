...
const INLLBrochure = () => {
  return (
    <div className="font-sans  bg-amber-400 text-[#0e1737]">
      {/* Hero Section */}
      <header className="relative bg-cover bg-center h-[500px] flex flex-col md:flex-row items-center justify-between px-8 py-12">
        {/* Left Content */}
        ...
        <div className="w-full md:w-1/2 flex justify-center md:justify-end mt-8 md:mt-0">
          <img
            src={bannerImage}
            alt="Hero"
            className="rounded-lg h-[300px] w-auto object-cover "
          />
        </div>
      </header>
      ...
      <nav className="bg-[#0e1737] py-3">
        <div className="max-w-6xl mx-auto px-4">
          <ul className="flex space-x-2 text-sm text-white">
            ...
            <li>/</li>
            <li className="text-white">INLL</li>
          </ul>
        </div>
      </nav>
      ...
      <section className="max-w-4xl mx-auto py-12 px-8">
        <div className="p-8 rounded-lg shadow-lg flex flex-col md:flex-row items-center gap-8">
          {/* Content on the left */}
